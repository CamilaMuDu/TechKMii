    ...
    public class ClienteDAL : IClienteDAL
    {
        ...
        public async Task<Cliente> Update(Cliente cliente)
        {
            ...
            try
            {
                ...
                command.Parameters.AddWithValue("@Sexo", cliente.Sexo.ToString());
                command.Parameters.AddWithValue("@Telefono", cliente.Telefono);
                command.Parameters.AddWithValue("@Correo", cliente.Correo);
                command.Parameters.AddWithValue("@Direccion", cliente.Direccion);
                command.Parameters.AddWithValue("@TipoIdentificacion", cliente.TipoIdentificacion.ToString());
                command.Parameters.AddWithValue("@Provincia", cliente.Provincia);
                command.Parameters.AddWithValue("@Fotografia", (object)cliente.Fotografia ?? DBNull.Value);
                command.Parameters.AddWithValue("@Estado", (int)cliente.Estado);
